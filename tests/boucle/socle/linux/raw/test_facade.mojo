...
(`boucle.socle.linux.raw.x86_64` or `boucle.socle.linux.raw.aarch64`) to
force name resolution through the facade in
`boucle/socle/linux/raw/__init__.mojo`. If any source module is dropped
...
from boucle.socle.linux.raw import syscall  # syscall.mojo
from boucle.socle.linux.raw import __NR_close, __kernel_timespec  # general.mojo
from boucle.socle.linux.raw import EPOLLIN, epoll_event  # epoll.mojo
from boucle.socle.linux.raw import EAGAIN, EINTR, EBADF  # errno.mojo
from boucle.socle.linux.raw import IORING_OP_NOP, IORING_OP_RECV, io_uring_buf  # io_uring.mojo
from boucle.socle.linux.raw import AF_INET, sockaddr_in, msghdr  # net.mojo
from boucle.socle.linux.raw import UCONTEXT_SIZE, REG_RIP  # ucontext.mojo
