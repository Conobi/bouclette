...
from bouclette.net.addr import SocketAddrStorAny, SocketAddrV4, SocketAddrV6
...
def test_from_sockaddr_unspec_for_short_or_unknown() raises:
    """Fewer than two bytes, or a family bouclette does not model, is UNSPEC."""
