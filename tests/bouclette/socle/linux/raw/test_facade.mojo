...
(`bouclette.socle.linux.raw.x86_64` or `bouclette.socle.linux.raw.aarch64`) to
force name resolution through the facade in
`bouclette/socle/linux/raw/__init__.mojo`. If any source module is dropped
...
from bouclette.socle import is_aarch64
from bouclette.socle.linux.raw import syscall  # syscall.mojo
from bouclette.socle.linux.raw import __NR_close, __kernel_timespec  # general.mojo
from bouclette.socle.linux.raw import EPOLLIN, epoll_event  # epoll.mojo
from bouclette.socle.linux.raw import EAGAIN, EINTR, EBADF  # errno.mojo
from bouclette.socle.linux.raw import IORING_OP_NOP, IORING_OP_RECV, io_uring_buf  # io_uring.mojo
from bouclette.socle.linux.raw import AF_INET, sockaddr_in, msghdr  # net.mojo
from bouclette.socle.linux.raw import UCONTEXT_SIZE, REG_RIP  # ucontext.mojo
