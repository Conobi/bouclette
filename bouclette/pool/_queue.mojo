...
shared eventfd (`bouclette.pool._notify`).

A `pthread_mutex_t` (`bouclette.socle.linux.thread._Mutex`) guards the two
...
from bouclette.handle import OwnedHandle, RawHandle
from bouclette.pool._notify import _notify_raw
from bouclette.proactor.completion import Completion
from bouclette.socle.linux.thread import _Condvar, _Mutex
