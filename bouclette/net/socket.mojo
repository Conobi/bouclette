...
from bouclette.net.ip import IpAddrV4, IpAddrV6
from bouclette.net.options import (
    AddrFamily,
    SocketType,
    SocketFlags,
    Protocol,
...
#
# This is also bouclette's error boundary: the socle layer reports failures as an
