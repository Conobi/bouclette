...
caller. Reach for `bouclette.WatchLoop` instead; use this only when you
...
from bouclette.proactor.completion import Completion, CompletionFn
from bouclette.proactor.loop import EventLoop
from bouclette.drivers import _CompletionDriver
...
struct CompletionLoop(Movable):
    ...
    def multishot_recvmsg(
        ...
        parse the buffer with `bouclette.net.message.DeliveryHeader`. The
