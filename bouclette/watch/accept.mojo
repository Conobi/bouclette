...
from bouclette.net.options import SocketType
from bouclette.net.socket import Socket
from bouclette.proactor.completion import Completion
from bouclette.socle.platform import close_unchecked
from bouclette.watch._callback import _FutureCallback, _SlotLink, _dispatch
...
struct AcceptFuture(Movable):
    ...
    def result(mut self) raises -> Socket:
        ...
        `IOError` carrying the errno, the same type every bouclette I/O call
