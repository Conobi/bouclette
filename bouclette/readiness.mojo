...
See `bouclette.watch` (`WatchLoop`) for the completion model.
"""

from bouclette.drivers import _ReadinessDriver
from bouclette.drivers.backend import Backend
from bouclette.drivers.readiness_event import ReadinessEvent
...
struct ReadinessLoop[Handler: ReadinessHandler](Movable):
    ...
    comptime `_ReadinessDriver` alias in `bouclette.drivers`.
    """
